defmodule BuzzWeb.UserSocket do
  use Phoenix.Socket
  ...
  # pointing to the `BuzzWeb.RoomChannel`:
  #
  channel "room:*", BuzzWeb.RoomChannel
  #
  ...
  #
  #     Elixir.BuzzWeb.Endpoint.broadcast("user_socket:#{user.id}", "disconnect", %{})
  #
